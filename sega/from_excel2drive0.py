...
for city in range(3,31):
    cities+=[sheet.cell(row=city, column=2).value]
#print (cities)

stores = [] #список магазинов

for store in range (3,31):
    stores +=[sheet.cell(row=store, column=3).value]
#print (stores)

dates = []
for date in range (3,31):
    dates +=[sheet.cell(row=date, column=7).value.date()]
#print(dates)
...
for city2 in range(3,31):
    cities2+=[sheet2.cell(row=city2, column=2).value]
#print (cities)

stores2 = [] #список магазинов

for store2 in range (3,7):
    stores2 +=[sheet2.cell(row=store2, column=3).value]

dates2 = []
for date in range (3,7):
    dates2 +=[sheet2.cell(row=date, column=8).value.date()]
#print (dates2)
positions2 = []
...
for count2 in range (3,7):
    wks2.update_cell('AT'+str(count2), sheet2['AS'+str(count2)].value)
